...
@if ($showField)
    ...
    >
        <div class="dz-message needsclick">
            {{ trans('plugins/car-rentals::car-rentals.car.forms.images_upload_placeholder') }}<br>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            var dropzone = new Dropzone('#multiple-upload', {
                ...
                timeout: 0, // MB,
                maxFilesize: {{ CarRentalsHelper::maxFilesizeUploadByVendor() }}, // MB
                maxFiles: {{ CarRentalsHelper::maxPostImagesUploadByVendor() }}, // max files upload,
                paramName: 'file',
                acceptedFiles: 'image/*',
                url: '{{ route('car-rentals.vendor.upload') }}',
                ...
                removedfile: function(file) {
                    ...
                    if (dropzone.options.maxFiles ===
                        {{ CarRentalsHelper::maxPostImagesUploadByVendor() }}) {
            ...
            @if ($options['value'])
                @php
                    $options['value'] = is_array($options['value']) ? $options['value'] : json_decode($options['value'], true);
                @endphp
                var files = [];
